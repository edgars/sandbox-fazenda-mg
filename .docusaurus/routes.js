...
export default [
  ...
  {
    path: '/',
    component: ComponentCreator('/', '3af'),
    routes: [
      {
        path: '/',
        ...
        routes: [
          {
            path: '/',
            component: ComponentCreator('/', '566'),
            routes: [
              {
                path: '/category/datasets---iniciais',
                component: ComponentCreator('/category/datasets---iniciais', 'e89'),
                exact: true,
              ...
              {
                path: '/tutorial-basics/NfeNfce',
                component: ComponentCreator('/tutorial-basics/NfeNfce', '83c'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
